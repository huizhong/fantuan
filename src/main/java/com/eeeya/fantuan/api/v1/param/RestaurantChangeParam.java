package com.eeeya.fantuan.api.v1.param;
...
public class RestaurantChangeParam {
    ...
    public RestaurantChangeParam(Boolean isFarther, Double userLatitude, Double userLongitude) {
        this.isFarther = isFarther;
        this.userLatitude = userLatitude;
        this.userLongitude = userLongitude;
    }

    public RestaurantChangeParam() {
    }
